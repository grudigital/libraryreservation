...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-md-8 order-md-1">
            ...
            <form action="functions/gravar2.php" enctype="multipart/form-data" method="post" class="needs-validation" novalidate>
                ...
                echo "<div class='row'>";
                    ...
                    echo "</div>";
                echo "<div class='mb-3'>";
                    echo "<label for='email'>Email <span class='text-muted'></span></label>";
