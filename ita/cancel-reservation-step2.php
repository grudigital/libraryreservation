    ...
    <section class="resume-section" id="about">
		...
		if (date('H') < 15) {
            ...
            <table class='table'>
                ...
                require("../admin/connections/conn.php");
                $pegaid = (int)$_GET['codigo'];
                $sql = "select id, codigo, nome, sobrenome, email, date_format(data, '%d/%m/%Y') as datareserva, periodo, cadastroem FROM reservas where codigo = '$pegaid' and data != 'null' and order by data desc";
                $result = mysqli_query($conn, $sql);
                $num_rows = mysqli_num_rows($result);
                if ($num_rows == 0) {
                    echo "<div class='alert alert-danger' role='alert'>";
