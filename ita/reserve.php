...
<div class="container menu-novo">
    <div class="row">
        ...
        <div class="col-2" >
            <a class="botoes-idioma" href='../ger/reserve.php'>
                <button>DE</button>
            </a>
            <a class="botoes-idioma" href='../eng/reserve.php'>
                <button>EN</button>
            </a>
            <a class="botoes-idioma" href='../ita/reserve.php'>
                <button>IT</button>
            </a>
        </div>
    </div>
...
<div class="container conteudo-projeto">
    <section class="resume-section" id="about">
        <div class="resume-section-content">
            ...
            <p><?php
                require("../admin/connections/conn.php");
                $sql = "select id, italy FROM languages where id=6";
                $result = mysqli_query($conn, $sql);
                while ($row = mysqli_fetch_assoc($result)) {
                    echo "$row[italy]";
                }
            ...
            <form action="functions/reservation-step1.php" enctype="multipart/form-data" method="post" class="needs-validation" novalidate>
                <div class="mb-3">
                    <label class="username">
                        <?php
                        require("../admin/connections/conn.php");
                        $sql = "select id, italy FROM languages where id=18";
                        $result = mysqli_query($conn, $sql);
                        while ($row = mysqli_fetch_assoc($result)) {
                            echo "$row[italy]";
                        }
                ...
                <div class="mb-3">
                    <label class="username">
                        <?php
                        require("../admin/connections/conn.php");
                        $sql = "select id, italy FROM languages where id=29";
                        $result = mysqli_query($conn, $sql);
                        while ($row = mysqli_fetch_assoc($result)) {
                            echo "$row[italy]";
                        }
