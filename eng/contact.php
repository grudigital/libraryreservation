    ...
    <div class="container">
        <div class="row">
            <div class="col-sm flags-header">
                <a href="../ger/contact.php">DE</a>
            </div>
            <div class="col-sm flags-header">
                <a href="../eng/contact.php">EN</a>
            </div>
            <div class="col-sm flags-header">
                <a href="../ita/contact.php">IT</a>
            </div>
        </div>
    </div>
</nav>
        ...
        <div class="resume-section-content">
            ...
            <div style="margin-top: 50px" class="mb-5">
                <p><strong>
                    ...
                    <?php
                    require("../admin/connections/conn.php");
                    $sql = "select id, english FROM languages where id=24";
                    $result = mysqli_query($conn, $sql);
                    while ($row = mysqli_fetch_assoc($result)) {
                        echo "$row[english]";
                    }
                ...
                <p>
                    ...
                    <?php
                    require("../admin/connections/conn.php");
                    $sql = "select id, english FROM languages where id=25";
                    $result = mysqli_query($conn, $sql);
                    while ($row = mysqli_fetch_assoc($result)) {
                        echo "$row[english]";
                    }
