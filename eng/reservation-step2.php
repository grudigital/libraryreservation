...
<div class="container">
    <div class="row">
        <div class="col-sm flags-header">
            <a href="../eng/reservation-step2.php"><?php include 'includes/flag_eng.php'?></a>
        </div>
        <div class="col-sm">
            <a href="../ger/reservation-step2.php"><?php include 'includes/flag_ger.php'?></a>
        </div>
        <div class="col-sm">
            <a href="../ita/reservation-step2.php"><?php include 'includes/flag_ita.php'?></a>
        </div>
    </div>
</div>
</nav>
