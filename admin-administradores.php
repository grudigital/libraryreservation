        ...
        <div class="col-md-12 order-md-1">
            ...
            <hr class="mb-4">
                ...
                <div class="container bloco-botoes">
                    <div class="row">
                        <div class="col"><a href="functions/exportar-administradores.php"><button class="btn btn-primary btn-lg btn-block" name="submit" type="submit">Export data</button></a></div>
                        <div class="col"><a href="admin-administradores-adicionar.php"><button class="btn btn-secondary btn-lg btn-block" name="submit" type="submit">Add</button></a></div>
                    </div>
                </div>
                ...
                <table class="table">
                    ...
                    echo "<tr>";
                        ...
                        echo "<td><a href='functions/administradores-excluir.php?id=$row[id]'><button class='btn btn-danger btn-lg btn-block botao-excluir' >X</button></a></td>";
                    echo "</tr>";
