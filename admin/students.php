        ...
        <section class="resume-section">
            <div class="resume-section-content">
                <div class="col-md-12 order-md-1">
                    <h4 class="mb-3">Students management</h4>
                    <hr class="mb-4">
                    <div class="container bloco-botoes">
                        <div class="row">
                            <div class="col">
                                <a href="functions/reportstudents.php"><button class="btn btn-primary btn-lg btn-block" name="submit" type="submit">Export data
                                    </button></a>
                            </div>
                            <div class="col"><a href="studentsadd.php">
                    ...
                    <table class="table">
                        ...
                        while ($row = mysqli_fetch_assoc($result)) {
                            ...
                            if ($row['aceite'] == '1') {
                                echo "<td><a href='functions/statusstudent1.php?id=$row[id]'><button type='button' class='btn btn-success'>Signed</button></a></td>";
                            } else {
                                echo "<td><a href='functions/statusstudent2.php?id=$row[id]'><button type='button' class='btn btn-danger'>Didn´t Sign</button></a></td>";
                            }
                            echo "<td><a href='functions/studentsdelete.php?id=$row[id]'><button class='btn btn-danger btn-lg btn-block botao-excluir' >X</button></a></td>";
                            echo "</tr>";
