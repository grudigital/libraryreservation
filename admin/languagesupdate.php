    ...
    <div class="container-fluid p-0">
        <section class="resume-section">
            <div class="resume-section-content">
                <form action="functions/languagesupdate.php" enctype="multipart/form-data" method="post"
                    ...
                    <table class="table">
                        ...
                        <tr>
                            <th scope="col">#</th>
                            <th scope="col"><img width="70px" height="37px" src="../assets/img/flag-english.png"></th>
                            <th scope="col"><img width="70px" height="37px" src="../assets/img/flag-germany.png"></th>
                            <th scope="col"><img width="70px" height="37px" src="../assets/img/flag-italy.png"></th>
                        ...
                        $pegaid = (int) $_GET['id'];
                        $sql = "select * FROM languages where id = '$pegaid'";
                        $result = mysqli_query($conn, $sql);
                        while ($row = mysqli_fetch_assoc($result)) {
                            echo "<tr>";
                            echo "<th scope='row'>$row[id]</th>";
                            echo "<input type='hidden' name='id' value='$row[id]'>";
                            echo "<td><textarea name='english' class='form-control'>$row[english]</textarea></td>";
                            echo "<td><textarea name='germany' class='form-control'>$row[germany]</textarea></td>";
                            echo "<td><textarea name='italy' class='form-control'>$row[italy]</textarea></td>";
                            echo "</tr>";
                        }
                        ?>
                        </tbody>
