        ...
        <section class="resume-section">
            <div class="resume-section-content">
                <div class="col-md-12 order-md-1">
                    <h4 class="mb-3">Tomorrow reservations

                        <?php
                        require ("connections/conn.php");
                        $sql = "select id, codigo, nome, sobrenome, email, date_format(data, '%d/%m/%Y') as datareserva, periodo, date_format(cadastroem, '%d/%m/%Y') as datacadastro FROM reservas where data = curdate() +1";

                        $executa_query = mysqli_query($conn, $sql);
                        $conta_linhas = mysqli_num_rows($executa_query);
                        echo "(". $conta_linhas ." reservations in this period)";
                        ?>
                    ...
                    <div class="container bloco-botoes">
                        <div class="row">
                            <div class="col"><a href="functions/reportreservationtomorrow.php"><button class="btn btn-primary btn-lg btn-block" name="submit" type="submit">Export data</button></a></div>
                        </div>
                    </div>
