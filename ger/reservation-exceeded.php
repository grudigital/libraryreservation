    ...
    <section class="resume-section" id="about">
        <div class="resume-section-content">
            ...
            <div class="alert alert-danger" role="alert">
                <?php
                require("../admin/connections/conn.php");
                $sql = "select id, germany FROM languages where id=22";
                $result = mysqli_query($conn, $sql);
                while ($row = mysqli_fetch_assoc($result)) {
                    echo "$row[germany]";
                }
            ...
            <table class='table'>
                ...
                if ($num_rows == 0) {
                    ...
                    while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        echo "<td><a href='functions/cancel-step2.php?id=$row[id]'><button class='btn btn-danger btn-lg btn-block botao-cancelar' type='button'>Reservierung stornieren</button></a></td>";
                        echo "</tr>";
                    }
                }
                mysqli_close($conn);
