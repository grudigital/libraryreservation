...
<div class="container">
    <div class="row">
        <div class="col-sm flags-header">
            <a href="../eng/cancel-reservation-step2.php"><img width="100%" height="35px" src="../assets/img/flag-english.png"></a>
        </div>
        <div class="col-sm">
            <a href="../ger/cancel-reservation-step2.php"><img width="100%" height="35px" src="../assets/img/flag-germany.png"></a>
        </div>
        <div class="col-sm">
            <a href="../ita/cancel-reservation-step2.php"><img width="100%" height="35px" src="../assets/img/flag-italy.png"></a>
        </div>
    </div>
</div>
</nav>
