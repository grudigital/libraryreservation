...
<div class="container">
    <div class="row">
        <div class="col-sm flags-header">
            <a href="../eng/reservation-step2.php"><img width="100%" height="35px" src="../assets/img/flag-english.png"></a>
        </div>
        <div class="col-sm">
            <a href="../ger/reservation-step2.php"><img width="100%" height="35px" src="../assets/img/flag-germany.png"></a>
        </div>
        <div class="col-sm">
            <a href="../ita/reservation-step2.php"><img width="100%" height="35px" src="../assets/img/flag-italy.png"></a>
        </div>
    </div>
</div>
</nav>
...
//                        echo "</div>";
                        ...
                        echo "<hr class='mb-4'>";
                        echo "<button class='btn btn-primary btn-lg btn-block' type='submit'>Reservieren</button>";
                        echo "</div>";
                        echo "</div>";
                    }
                }
